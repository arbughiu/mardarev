...
export interface Project {
  ...
  title: string;
  slug: string;
  category?: ('rezidential' | 'comercial' | 'interior' | 'peisagistica') | null;
  /**
   * Etichetă afișată pentru categorie (ex: "Rezidențial")
   */
...
export interface ContactForm {
  ...
  email: string;
  phone?: string | null;
  projectType?: ('rezidential' | 'comercial' | 'interior' | 'peisagistica') | null;
  message: string;
  status?: ('new' | 'in_progress' | 'resolved' | 'spam') | null;
  /**
   * Note interne - vizibile doar pentru administratori
   */
  notes?: string | null;
  updatedAt: string;
  createdAt: string;
